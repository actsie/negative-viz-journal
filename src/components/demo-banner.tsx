...
export default function DemoBanner() {
  ...
  useEffect(() => {
    // Show banner if explicitly in demo mode OR if domain contains 'demo' or it's a Vercel deployment
          ...
          <div>
            ...
            <div className="space-y-2">
              <p className="text-sm text-blue-800 leading-relaxed">
                You can test the negative visualization journal, but entries and settings may reset periodically. In the full app, all data is saved permanently to your device.
              </p>
              <p className="text-sm text-red-700 font-medium leading-relaxed">
                ⚠️ Privacy Warning: This demo shares data across all users. Do not write sensitive personal thoughts or private journal entries.
              </p>
            </div>
          </div>
        </div>
